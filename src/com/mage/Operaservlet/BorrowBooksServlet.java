...
//			System.out.println(userid);
			...
			if(request.getParameter("userid")==null) {
				...
				//3. 显示数据
				//存数据
				if("1".equals(user.getIsfull())){
					request.getSession().setAttribute("message","当前欠费，请归还已过期限图书");
					response.sendRedirect("bookManager/BorrowBook.jsp");
					System.out.println("欠费无法借书");
				}
				else {
